...
var t=function(a,n,t){e.post("",{func:"changeComplete",userId:s,type:a,id:n,completed:t}),r.user+=t,i()},l=function(){var a=e(this),s=a.hasClass("circle")?a.parent():a.parent().parent(),r=s.attr("id").replace("module_","").replace("assignment_","").replace("milestone_",""),i=s.attr("id").split("_")[0],n=a.hasClass("circle")?a:e(a.parent().parent().children(".circle")[0])
